...
> ### Conclusion 
```bash showLineNumbers=false
And that's it, This is a brief look at Pure Data, and a simple article to let you know what it is and why I consider it my favorite instrument and visual programming language. Thank you for reading <3
```
